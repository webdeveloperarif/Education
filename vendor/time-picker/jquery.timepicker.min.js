...
!(function (a) {
  ...
  function c(b) {
    if (
      (b.minTime && (b.minTime = u(b.minTime)),
      b.maxTime && (b.maxTime = u(b.maxTime)),
      b.durationTime &&
        "function" != typeof b.durationTime &&
        (b.durationTime = u(b.durationTime)),
      "now" == b.scrollDefault)
    )
    ...
    if (
      ...
      for (var d in b.disableTimeRanges)
        b.disableTimeRanges[d] = [
          u(b.disableTimeRanges[d][0]),
          u(b.disableTimeRanges[d][1]),
        ];
  ...
  function d(b) {
    ...
    m > o && (o += w),
      o === w - 1 && "string" === a.type(c.timeFormat) && c.show2400 && (o = w);
    ...
    if (
      ...
      "string" == typeof F ? (F = a(F)) : "function" == typeof F && (F = F(b)),
        F.append(g),
        k(b, d),
        d.on("mousedown touchstart", "li", function (c) {
  ...
  function h(b) {
    ...
    0 === d.length &&
      0 === c.closest(".ui-timepicker-wrapper").length &&
      (y.hide(),
  ...
  function l(b, c) {
    if ("" !== this.value && "timepicker" != c) {
      ...
      if (!d.is(":focus") || (b && "change" == b.type)) {
        ...
        var g = !1;
        null !== e.minTime && f < e.minTime
          ? (g = !0)
          : null !== e.maxTime && f > e.maxTime && (g = !0),
  ...
  function n(a, b, c) {
    if (a.is("input")) {
      ...
      d.useSelect &&
        "select" != c &&
        "initial" != c &&
        a.data("timepicker-list").val(f(u(b), d));
    }
  ...
  function r(a) {
    ...
    return e.hasClass("ui-timepicker-disabled")
      ...
      : (e.length && (d = e.data("time")),
        null !== d &&
          ("string" != typeof d && (d = t(d, b)), n(a, d, "select")),
        !0);
  }
  function s(a, b) {
    a = Math.abs(a);
    ...
    return (
      60 > e
        ...
        : ((c = Math.floor(e / 60)),
          (d = e % 60),
          30 == b && 30 == d && (c += x.decimal + 5),
          f.push(c),
          f.push(1 == c ? x.hr : x.hrs),
          30 != b && d && (f.push(d), f.push(x.mins))),
      f.join(" ")
    );
  }
  function t(b, c) {
    ...
    for (var e, f, g = "", h = 0; h < c.timeFormat.length; h++)
  ...
  var v = g(),
    ...
    y = {
      init: function (b) {
        return this.each(function () {
          ...
          if (
            ...
            e.on("change.timepicker", l),
              e.on("keydown.timepicker", p),
              e.on("keyup.timepicker", q),
              h.disableTextInput && e.on("keydown.timepicker", o),
              l.call(e.get(0));
          }
        });
      },
      show: function (c) {
        ...
        if (
          !e.prop("readonly") &&
          ((g && 0 !== g.length && "function" != typeof f.durationTime) ||
            (d(e), (g = e.data("timepicker-list"))),
          !b(g))
        ) {
          ...
          f.orientation.match(/r/)
            ? (l.left =
                ...
                e.outerWidth() -
                g.outerWidth() +
                parseInt(g.css("marginLeft").replace("px", ""), 10))
            : (l.left =
                e.offset().left +
                parseInt(g.css("marginLeft").replace("px", ""), 10));
          var n;
          (n = f.orientation.match(/t/)
            ...
            ? "b"
            : e.offset().top + e.outerHeight(!0) + g.outerHeight() >
              a(window).height() + a(window).scrollTop()
            ? "t"
            : "b"),
            "t" == n
              ? (g.addClass("ui-timepicker-positioned-top"),
                (l.top =
                  e.offset().top -
                  g.outerHeight() +
                  parseInt(g.css("marginTop").replace("px", ""), 10)))
              : (g.removeClass("ui-timepicker-positioned-top"),
                (l.top =
                  e.offset().top +
                  e.outerHeight() +
                  parseInt(g.css("marginTop").replace("px", ""), 10))),
          ...
          if (!o.length) {
            ...
            null !== p
              ? (o = j(e, g, p))
              : f.scrollDefault && (o = j(e, g, f.scrollDefault()));
          }
          if (o && o.length) {
          ...
          return (
            ...
            a(window).on("resize.ui-timepicker", h),
            f.closeOnWindowScroll && a(document).on("scroll.ui-timepicker", h),
      ...
      setTime: function (a) {
        ...
        return (
          ...
          n(b, d),
          b.data("timepicker-list") && k(b, b.data("timepicker-list")),
          this
        );
      },
      remove: function () {
